...
namespace MySql.Data.MySqlClient
{
  ...
  public sealed partial class MySqlClientFactoryMySqlConnector : DbProviderFactory, IServiceProvider
  {
    /// <summary>
    /// Gets an instance of the <see cref="MySqlClientFactoryMySqlConnector"/>. 
    /// This can be used to retrieve strongly typed data objects. 
    /// </summary>
    public static MySqlClientFactoryMySqlConnector Instance = new MySqlClientFactoryMySqlConnector();
    ...
    {
      return new MySqlConnector.MySqlCommandBuilder();
    }
    ...
    {
      return new MySqlConnector.MySqlDataAdapter();
    }
