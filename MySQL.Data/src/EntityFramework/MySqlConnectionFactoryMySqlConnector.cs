...
namespace MySql.Data.EntityFramework
{
  ...
  /// </summary>
  public class MySqlConnectionFactoryMySqlConnector : IDbConnectionFactory
  {
    string baseConnString;

    public MySqlConnectionFactoryMySqlConnector()
    {
    }

    public MySqlConnectionFactoryMySqlConnector(string connStr)
    {
