...
namespace MySqlCustom
{
  ...
  /// </summary>
  public class MySqlDependencyResolverMySqlConnector : IDbDependencyResolver
  {
    /// <summary>
      ...
      if (Enum.TryParse(type.Name, true, out servType))
      {
        switch (servType)
        {
          case EServiceType.DbProviderFactory:
            return new MySql.Data.MySqlClient.MySqlClientFactoryMySqlConnector();
          case EServiceType.IDbConnectionFactory:
            return new MySql.Data.EntityFramework.MySqlConnectionFactoryMySqlConnector();
          case EServiceType.MigrationSqlGenerator:
            return new MySql.Data.EntityFramework.MySqlMigrationSqlGenerator();
          case EServiceType.DbProviderServices:
            return new MySqlCustom.MySqlProviderServices();
          ...
          case EServiceType.IDbExecutionStrategy:
            return new MySql.Data.EntityFramework.MySqlExecutionStrategy();
        }
      }
      return null;
    }
  ...
  {
    private const string _providerName = "ProviderMySqlConnector";
  ...
  public class MySqlManifestTokenResolver : IManifestTokenResolver
  {
    ...
    {
      return MySqlCustom.MySqlProviderServices.GetProviderServices(connection).GetProviderManifestToken(connection);
    }
  }
  ...
  internal class MySqlModelCacheKeyFactory
  {
    public IDbModelCacheKey Create(System.Data.Entity.DbContext context)
    {
      ...
      return new MySqlModelCacheKey(context.GetType(), MySqlProviderInvariantName.ProviderName, typeof(MySql.Data.MySqlClient.MySqlClientFactoryMySqlConnector), customKey);
    }
  }
